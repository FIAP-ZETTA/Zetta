...
echo [1/3] Iniciando o backend ZettaScan na porta 8000...
...
echo [2/3] Instalando dependencias do ZettaDash (aguarde)...
cd /d "%~dp0zettadash"
...
:com_pnpm
call pnpm install
echo [3/3] Abrindo ZettaDash em http://localhost:3000 ...
